...
$user		= JFactory::getUser();
	        ...
	        $link = JRoute::_( 'index.php?option=com_christianconnect&task=category.edit&id='. (int)$row->id );
	...
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td>
		 ...
		 <?php echo JHtml::_('jgrid.published', $row->published, $i, 'categories.', $canChange, 'cb'); ?>
