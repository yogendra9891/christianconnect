		  ...
		  <div class="profilenotifyimage"><img src="<?php echo $img; ?>" height=100px; width=100px;/></div>
			...
			<?php if(!empty($message->fname)) $name = $message->fname; else  $name = $message->email;?>
			 	...
			 	<div class="messagebody"> <div class="sendername"><a href="<?php echo JRoute::_('index.php?option=com_myfriend&task=myfriendss.viewrequestprofile&userid='.$message->messagefrom.'&Itemid='.$itemid);?>"><?php echo $name;?></a></div>
				 	...
				 	<?php if(@$message->threadid > 0) echo JText::_('COM_MYFRIEND_MESSAGE_TO_YOU'); else echo JText::_('COM_MYFRIEND_MESSAGE_TO_YOU');?></a>
			 	</div>
			 	...
			 	<div id="unreadmessage"><a href="#" id="<?php echo $message->messageid;?>" name="<?php echo $message->threadid;?>" class="unreadfriendmessage"><span><span><?php echo JText::_('COM_MYFRIEND_MARK_UNREAD_MESSAGE');?></span></span> </a></div>
			 	<?php }?>
			 	<div id="deletemessage"><a href="javascript:void(0);" id="<?php echo $message->messageid;?>" name="<?php echo $message->threadid;?>" class="deletefriendmessage"><span><span><?php echo JText::_('COM_MYFRIEND_MESSAGE_DELETE');?></span></span></a></div>
			 	</li>
		<?php }?>
		</ul>
  <div>
