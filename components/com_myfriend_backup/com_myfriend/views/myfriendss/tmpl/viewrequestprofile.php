	       ...
	       var url='index.php?option=com_myfriend&task=myfriendss.acceptrequest';	 
	    	   $.ajax({
		        ...
		        success: function(data) {
		            ...
		            $('#viewrequestprofile-form').submit();	            
		        }
		  });      
	});

	$('.friendrequestreject').click(function(){ 
...
<form action="<?php echo JRoute::_('index.php?option=com_myfriend&task=myfriendss.viewrequestprofile&userid='.$this->userid.'&requestid='.$this->requestid.'&Itemid='.$itemid); ?>" name="viewrequestprofile-form" method="post" id="viewrequestprofile-form">
...
<div class="friendprofileimage">
          ...
          ?>
	<?php if(!empty($this->items['fname'])) $name = $this->items['fname']; else  $name = $this->items['email'];?>
	<div id="finalacceptrequest_<?php echo $this->requestid;?>" style="display:none;"><h2><?php echo JText::_('COM_MYFRIEND_YOU_ARE_NOW_FRIEND').' '.$name?></h2></div>

	<div class="requestedprofileimage" id="requestedprofileimage">
		<img src="<?php echo $img;?>" height="100" width="100">
	 </div>
<?php if(empty($this->deinedfriend)&&(empty($this->friend))) { ?>
	<div class="acceptremoverequest" id="requestacceptremove">
		<a href="#" class="friendrequestaccept" id="friendaccept_<?php echo $this->requestid;?>" name="<?php echo $this->requestid;?>">
			<span><span><?php echo JText::_('COM_MYFRIEND_REQUEST_ACCEPT');?> </span></span>
		</a>
		<a href="#" class="friendrequestreject" id="friendreject_<?php echo $this->requestid;?>" name="<?php echo $this->requestid;?>">
			<span><span><?php echo JText::_('COM_MYFRIEND_REQUEST_REJECT');?> </span></span>
		</a>
	</div>
<?php }?>
...
?>
<div class="sharemessagearea" id="sharemessagearea">
...
<input type="hidden" name="friendsuccess" id="friendsuccess" value="" />
</div>
</div>
